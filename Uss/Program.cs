	...
	class Program
	{
		static void Main(string[] args)
		{
...

			{
				Menu menu = new Menu();
				menu.MainMenu();
				Walls walls = new Walls(50, 20); // Создает стены для змейки по размерам рамки (меньше значения не работают) 
				walls.Draw();
				...
				FoodCreator foodCreator = new FoodCreator(50, 20, '$'); //Создание объекта еда с условиями длина,ширина карты и символ как еда будет выглядеть
